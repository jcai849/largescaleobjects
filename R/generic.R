...
colClasses	<- function(x, ...) UseMethod("colClasses", x)
...
file		<- function(x, ...) UseMethod("file", x)
pass		<- function(x, ...) UseMethod("pass", x)
path		<- function(x, ...) UseMethod("path", x)
preview		<- function(...) UseMethod("preview", ..1)
quote		<- function(x, ...) UseMethod("quote", x)
...
`colClasses<-` 	<- function(x, value) UseMethod("colClasses<-", x)
